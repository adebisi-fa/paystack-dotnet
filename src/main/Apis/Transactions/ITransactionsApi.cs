...
namespace PayStack.Net
{
    ...
    {
        TransactionInitializeResponse Initialize(
            string email,
            int amountInKobo,
        ...
        TransactionExportResponse Export(
            DateTime? from = null,
            DateTime? to = null,
            bool settled = false,
            string paymentPage = null
        );
        ReAuthorizationResponse RequestReAuthorization(
            string authorizationCode,
            string email,
            int amountInKobo,
            string reference = null,
        ...
        CheckAuthorizationResponse CheckAuthorization(
            string authorizationCode,
            string email,
            int amountInKobo
        );
        ...
        TransactionPartialDebitResponse PartialDebit(
            string authorizationCode,
            string currency,
            string amount,
            string email
